...
Below you can find the meaning for the used variables in our datasets.
...
**KUL holiday dummy**
* is_kul_holiday: binary variable indicating if it's a vacation period at KU Leuven 
...
1. _**Explore the noise data**_: these pages contain interactive visualizations concerning the noise levels and noise events data
2. _**Explore the weather data**_: these pages show interactive visualizations concerning the meteo data
3. _**Analyzing noise and weather together**_: these pages display visualizations that combine the noise and weather datasets
4. _**Modelling**_: these pages contain the different models we applied and a discussion of their results 
...
We suggest you start with **'Explore the noise data'**, following the order of the pages and discovering the storyline through them. In this section, interactive visualizations concerning the noise in the city of Leuven are shown. Here are some examples to show what you can expect:

![Alt Text](assets/Noise-heatmap-readme.png)

![Alt Text](assets/Noise-events-readme.png)
...
Further, you can discover how noise and weather are related by visiting the pages underneath **'Analyzing noise and weather together'**:

![Alt Text](assets/Noise-map-readme.png)

Finally, underneath the **'Modelling'** category, you can also find the pages for our models:


![Alt Text](assets/ARD-readme.png)

![Alt Text](assets/RF-readme.png)
...
* [Fotor: text-to-image AI](https://www.fotor.com/features/ai-image-generator/)
